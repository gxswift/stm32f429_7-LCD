...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { IMAGE_CreateIndirect, "Image", ID_IMAGE_0, 300, 137, 149, 181, 0, 0, 0 },
...
extern GUI_CONST_STORAGE GUI_BITMAP bmQQVIP;
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_PAINT:
	  ...
	  GUI_DrawBitmap(&bmQQ,100,20);
	//  GUI_DrawBitmapHWAlpha(&bmQQ, 400, 200);
	  break;
  case WM_INIT_DIALOG:
    //
  ...
  case WM_NOTIFY_PARENT:
	  ...
	  NCode = pMsg->Data.v;
	  switch (Id) {
	  case ID_BUTTON_0: // Notifications sent by 'information'
		  switch (NCode) {
